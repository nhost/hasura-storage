...
func TestManipulate(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:     "gif",
			filename: "testdata/nhost.gif",
			hash: []byte{
				0xfd, 0x49, 0x80, 0xff, 0x5c, 0x86, 0x67, 0xe6,
				0xff, 0xd7, 0xcf, 0x49, 0xa8, 0x75, 0xea, 0x75,
				0x2d, 0x96, 0x9b, 0x05, 0x75, 0x66, 0xbb, 0x53,
				0x46, 0x45, 0x6e, 0x50, 0xba, 0xb4, 0x37, 0x89,
			},
		},
		{
			name:     "jpg",
		...
		{
			name:     "tiff",
			filename: "testdata/nhost.tiff",
			hash: []byte{
				0x84, 0x6a, 0x5f, 0x43, 0x41, 0x96, 0x70, 0xf5,
				0x95, 0x78, 0xfa, 0x1c, 0xbc, 0xbb, 0xa8, 0xa8,
				0x76, 0x14, 0x02, 0x73, 0x91, 0x54, 0xd6, 0x9a,
				0xe6, 0x1a, 0x1f, 0xf6, 0x50, 0x67, 0x89, 0xa3,
			},
		},
		{
			name:     "webp",
